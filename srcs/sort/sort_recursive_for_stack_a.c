...
/*   Updated: 2022/03/22 23:10:06 by ttomori          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_stack *from_stack, t_stack *to_stack, size_t origin_size)
{
	...
	sort_recursive_for_stack_a(from_stack, to_stack, left_chunk_size);
	sort_recursive_for_stack_b(to_stack, from_stack, moved_chunk_size);
}
